...
contract TokenSender {
    ...
    function transfer(
        ...
        // Convert is to a signed message hash
        ...
        require(signer == sender, "Signature does not come from the sender");
        // Transfer the token from sender(signer) tp recipient
...
//Fix for signature replay attack
